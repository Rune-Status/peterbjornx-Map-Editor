...
/**
 * Created by IntelliJ IDEA. User: Peter Date: 6/24/11 Time: 7:21 PM Computer:
...
public class FloorPreviewPanel extends JPanel {
	...
	/**
	 * Created by IntelliJ IDEA. User: Peter Date: 6/24/11 Time: 7:24 PM Computer:
	 * Peterbjornx-PC.rootdomain.asn.local (192.168.178.27)
	 */
	public static enum FloorPreviewMode {
		RT3_GAME, RT3_GAME_LD, RT3_MAP, RT4P_OVERLAY, RT4P_UNDERLAY
	}
}
