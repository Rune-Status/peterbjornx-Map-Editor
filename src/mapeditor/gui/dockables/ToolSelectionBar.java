...
public class ToolSelectionBar {
	...
	private JToggleButton objEditorButton;
	...
	public ToolSelectionBar() {
		ChangeListener listener = new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				...
				if (objEditorButton.isSelected())
					tool = EditorTools.OBJECT_EDITOR;
				brushSizeLabel.setText(Integer.toString(slider1.getValue()));

				ObjectEditorPanel.disableComponents();
				if (objEditorButton.isSelected())
					ObjectEditorPanel.enableComponents();

				TileShaperPanel.disableComponenets();
				if (paintOverlayButton.isSelected() ||
						paintUnderlayButton.isSelected() ) {
					TileShaperPanel.enableComponents();
				}
		...
		objEditorButton.addChangeListener(listener);
	}
	...
	private void $$$setupUI$$$() {
		mainPane = new JPanel();
		mainPane.setLayout(new com.intellij.uiDesigner.core.GridLayoutManager(1, 26, new Insets(0, 0, 0, 0), -1, -1));
		paintOverlayButton = new JToggleButton();
		paintOverlayButton.setText("PO");
		paintOverlayButton.setToolTipText("Paint Overlay");
		...
		paintUnderlayButton.setToolTipText("Paint Underlay");
		...
		heighChgButton.setToolTipText("Modify height");
		...
		heightSetButton.setToolTipText("Set height");
		...
		applySettingsButton.setToolTipText("Apply settings");
		...
		slider1.setMaximum(28);
		slider1.setMinimum(1);
		slider1.setMinorTickSpacing(1);
		slider1.setPaintTicks(true);
		slider1.setValue(1);
		mainPane.add(slider1, new com.intellij.uiDesigner.core.GridConstraints(0, 16, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST, com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));


		final JLabel label1 = new JLabel();

		label1.setText("Brush size:");
		mainPane.add(label1, new com.intellij.uiDesigner.core.GridConstraints(0, 15, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST, com.intellij.uiDesigner.core.GridConstraints.FILL_NONE, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
		brushSizeLabel = new JLabel();
		brushSizeLabel.setText("1");
		mainPane.add(brushSizeLabel, new com.intellij.uiDesigner.core.GridConstraints(0, 17, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST, com.intellij.uiDesigner.core.GridConstraints.FILL_NONE, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));

		floodFillOButton = new JToggleButton();
		floodFillOButton.setText("FO");
		floodFillOButton.setToolTipText("Fill overlay");
		...
		floodFillUButton.setToolTipText("Fill underlay");
		...
		heightFillUButton.setToolTipText("Fill area demarked by underlay with set height");
		...
		heightFillOButton.setToolTipText("Fill area demarked by overlay with set height");
		...
		settingsFillOButton.setToolTipText("Fill area demarked by overlay with settings");
		...
		settingsFillUButton.setToolTipText("Fill area demarked by underlay with settings");
		...
		shapeOButton.setToolTipText("Smooth edges of overlay");
		...
		shapeUButton.setToolTipText("Smooth edges within underlay");
		...
		objEditorButton = new JToggleButton();
		objEditorButton.setText("OBJ");
		objEditorButton.setToolTipText("Object map editor");
		mainPane.add(objEditorButton, new com.intellij.uiDesigner.core.GridConstraints(0, 14, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER, com.intellij.uiDesigner.core.GridConstraints.FILL_NONE, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK | com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK | com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
		...
		buttonGroup.add(objEditorButton);
