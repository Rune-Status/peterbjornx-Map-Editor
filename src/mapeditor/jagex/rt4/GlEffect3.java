...
/**
 * Created by IntelliJ IDEA. User: Administrator Date: 8/1/11 Time: 11:42 AM To
...
public class GlEffect3 {
	...
	public static void setTextureMatrix(int arg0, int z, byte arg2, int arg3, int arg4, int arg5) {
		try {
			...
			throw ErrorHandling.method554(runtimeexception,
					("se.GA(" + arg0 + ',' + z + ',' + arg2 + ',' + arg3 + ',' + arg4 + ',' + arg5 + ')'));
		}
	}
	...
	public void setup(int parameter) {
		...
		if (texture1or2 || parameter >= 0) {
			...
			System.err.println("RX:" + rotateX + " RY:" + rotateY + " TX:" + translateX + " TY:" + translateY + " TZ"
					+ translateZ);
			if (texture1or2) {
