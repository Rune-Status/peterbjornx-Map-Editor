...
public abstract class Class26 {
			...
			do {
				...
				try {
					...
					if (!method1594(arg1, 474))
						break;
					i = (int) ((((long) arg0.nextInt() & 0xffffffffL) * (long) arg1) >> -1424455328);
				} catch (RuntimeException runtimeexception) {
					break while_1241_;
				}
				return i;
				...
				for (int i_29_ = 0; i_29_ < arg0; i_29_++) {
					for (int i_30_ = 0; i_30_ < arg2; i_30_++) {
						for (int i_31_ = 0; i_31_ < anInt484; i_31_++) {
							...
							int i_57_ = method1786(i_34_, (aShortArray487[i_40_ - -i_54_]), 13828, i_37_, i_33_);
							int i_58_ = method1786(i_50_, (aShortArray487[i_45_ - -i_54_]), 13828, i_37_, i_33_);
							int i_59_ = (((i_58_ + -i_57_) * i_41_ >> 393606316) + i_57_);
							i_57_ = method1786(i_34_, (aShortArray487[i_40_ - -i_53_]), 13828, i_48_, i_33_);
							i_58_ = method1786(i_50_, (aShortArray487[i_53_ + i_45_]), arg3 ^ 0x3604, i_48_, i_33_);
							int i_60_ = i_57_ + ((-i_57_ + i_58_) * i_41_ >> 93719564);
							int i_61_ = (((i_60_ - i_59_) * i_49_ >> 460247180) + i_59_);
							i_57_ = method1786(i_34_, (aShortArray487[i_56_ + i_40_]), arg3 ^ 0x3604, i_37_, i_44_);
							i_58_ = method1786(i_50_, (aShortArray487[i_56_ + i_45_]), 13828, i_37_, i_44_);
							i_59_ = i_57_ - -((i_58_ - i_57_) * i_41_ >> -1201375924);
							i_57_ = method1786(i_34_, (aShortArray487[i_40_ - -i_55_]), 13828, i_48_, i_44_);
							i_58_ = method1786(i_50_, (aShortArray487[i_55_ + i_45_]), arg3 + 13828, i_48_, i_44_);
							i_60_ = i_57_ - -(i_41_ * (i_58_ + -i_57_) >> -872615348);
							int i_62_ = i_59_ + (i_49_ * (i_60_ - i_59_) >> -199734388);
							method1011(i_31_, ((-i_61_ + i_62_) * i_46_ >> -140152532) + i_61_, (byte) -113);
						}
						write(0);
					}
				}
	...
	public static int method1786(int arg0, int arg1, int arg2, int arg3, int arg4) {
		while_1170_: do {
			int i;
			int i_5_;
			do {
			...
			int i_7_;
			try {
				int i_8_ = (i < 4 ? arg3 : 12 == i || -15 == (i ^ 0xffffffff) ? arg0 : arg4);
				i_7_ = (((i & 0x1 ^ 0xffffffff) == -1 ? i_5_ : -i_5_) - -(0 != (i & 0x2) ? -i_8_ : i_8_));
			} catch (RuntimeException runtimeexception) {
				break;
			}
			return i_7_;
