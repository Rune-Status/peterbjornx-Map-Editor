...
import mapeditor.gui.renderer.pgle.PglSun;
...
public class ModelRendererGL {
	...
	public void render() {
		if (triangleCount != 0) {
			if (aByte5026 != 0)
				updateBuffers(true, (!vertexPositions.upToDate && (aByte5026 & 0x1) != 0),
						(!vertexColours.upToDate && (aByte5026 & 0x2) != 0),
						(vertexNormals != null && !vertexNormals.upToDate && (aByte5026 & 0x4) != 0), false);
			updateBuffers(false, !vertexPositions.upToDate, !vertexColours.upToDate,
					vertexNormals != null && !vertexNormals.upToDate, !vertexTexCoords.upToDate);
			...
			if (vertexPositions.vertexBuffer == null || vertexColours.vertexBuffer == null
					|| (Class7_Sub1.useLighting && vertexNormals.vertexBuffer == null)
	...
	public static void method1888(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, float[] arg7,
			int arg8, float arg9, float arg10, float arg11) {
		arg0 -= arg3;
		arg1 -= arg4;
		arg2 -= arg5;
	...
	/*
	 * public Class148_Sub1 method1889(Class148_Sub1 arg0) { if (vertex_count == 0)
	 * return null; if (!bounds.upToDate) updateBounds(); int i; int i_10_; if
	 * (AthmosphericEffects.anInt934 > 0) { i = (bounds.maxX - (bounds.minY *
	 * PglSun.anInt934 >> 8)) >> 3; i_10_ = (bounds.minX - (bounds.maxY *
	 * PglSun.anInt934 >> 8)) >> 3; } else { i = (bounds.maxX - (bounds.maxY *
	 * PglSun.anInt934 >> 8)) >> 3; i_10_ = (bounds.minX - (bounds.minY *
	 * PglSun.anInt934 >> 8)) >> 3; } int i_11_; int i_12_; if
	 * (AthmosphericEffects.anInt928 > 0) { i_11_ = (bounds.maxZ - (bounds.minY *
	 * PglSun.anInt928 >> 8)) >> 3; i_12_ = (bounds.minZ - (bounds.maxY *
	 * PglSun.anInt928 >> 8)) >> 3; } else { i_11_ = (bounds.maxZ - (bounds.maxY *
	 * PglSun.anInt928 >> 8)) >> 3; i_12_ = (bounds.minZ - (bounds.minY *
	 * PglSun.anInt928 >> 8)) >> 3; } int i_13_ = i_10_ - i + 1; int i_14_ = i_12_ -
	 * i_11_ + 1; Class148_Sub1 class148_sub1; if (arg0 != null &&
	 * arg0.aByteArray3689.length >= i_13_ * i_14_) { class148_sub1 = arg0;
	 * class148_sub1.anInt2378 = class148_sub1.v1_x = i_13_; class148_sub1.anInt2373
	 * = class148_sub1.v1_y = i_14_; class148_sub1.method2010(); } else
	 * class148_sub1 = new Class148_Sub1(i_13_, i_14_, 0); class148_sub1.x_offset =
	 * i; class148_sub1.y_offset = i_11_; if (anIntArray5061.length < vertex_count)
	 * { anIntArray5061 = new int[vertex_count]; anIntArray5057 = new
	 * int[vertex_count]; } for (int i_15_ = 0; i_15_ < realVertexCount; i_15_++) {
	 * int i_16_ = (((vertex_x[i_15_] - (vertex_y[i_15_] * PglSun.anInt934 >> 8)) >>
	 * 3) - i); int i_17_ = (((vertex_z[i_15_] - (vertex_y[i_15_] * PglSun.anInt928
	 * >> 8)) >> 3) - i_11_); int i_18_ = vertexUsageCount[i_15_]; int i_19_ =
	 * vertexUsageCount[i_15_ + 1]; for (int i_20_ = i_18_; i_20_ < i_19_; i_20_++)
	 * { int i_21_ = vertexIndexes[i_20_] - 1; if (i_21_ == -1) break;
	 * anIntArray5061[i_21_] = i_16_; anIntArray5057[i_21_] = i_17_; } } for (int
	 * i_22_ = 0; i_22_ < triangle_count; i_22_++) { if (triangleAlpha[i_22_] <=
	 * 128) { short i_23_ = triangle_a[i_22_]; short i_24_ = triangle_b[i_22_];
	 * short i_25_ = triangle_c[i_22_]; int i_26_ = anIntArray5061[i_23_]; int i_27_
	 * = anIntArray5061[i_24_]; int i_28_ = anIntArray5061[i_25_]; int i_29_ =
	 * anIntArray5057[i_23_]; int i_30_ = anIntArray5057[i_24_]; int i_31_ =
	 * anIntArray5057[i_25_]; if (((i_26_ - i_27_) * (i_30_ - i_31_) - (i_30_ -
	 * i_29_) * (i_28_ - i_27_)) > 0)
	 * Rasterizer.method91(class148_sub1.aByteArray3689, i_29_, i_30_, i_31_, i_26_,
	 * i_27_, i_28_, i_13_); } } return class148_sub1; }
	 */
			...
			if (framesFrom2 == null || frame2 == -1)
				...
				for (int i_59_ = 0; i_59_ < animation.stepCount; i_59_++) {
					...
					if (i_60_ != i_58_ || modelTransform.opcodes[i_60_] == 0) {
						...
						// transformStep(0, (modelTransform.skinList[animation.aShortArray2338[i_59_]]),
						// 0, 0, 0, arg5);
						transformStep(modelTransform.opcodes[i_60_], modelTransform.skinList[i_60_],
								animation.xOffset[i_59_], animation.yOffset[i_59_], animation.zOffset[i_59_], arg5);
					}
				}
				vertexXModifier = 0;
				vertexYModifier = 0;
				...
				for (int i_61_ = 0; i_61_ < animation_57_.stepCount; i_61_++) {
					...
					if (i_62_ == i_58_ || modelTransform.opcodes[i_62_] == 0) {
						...
						// transformStep(0,
						// (modelTransform.skinList[animation_57_.aShortArray2338[i_61_]]), 0, 0, 0,
						// arg5);
						transformStep(modelTransform.opcodes[i_62_], modelTransform.skinList[i_62_],
								animation_57_.xOffset[i_61_], animation_57_.yOffset[i_61_],
								animation_57_.zOffset[i_61_], arg5);
					}
				}
	...
	public void method1895(boolean checkPositions, boolean checkColours, boolean checkNormals, boolean checkTexCoords,
			boolean checkElements, boolean arg5, boolean arg6) {
		if (aByte5026 != 0)
			throw new IllegalArgumentException();
		if (vertexCount != 0) {
			if (arg6) {
				boolean bool = (!vertexColours.upToDate && (checkColours || checkNormals && !Class7_Sub1.useLighting));
				updateBuffers(false, !vertexPositions.upToDate && checkPositions, bool,
						(vertexNormals != null && !vertexNormals.upToDate && checkNormals),
						!vertexTexCoords.upToDate && checkTexCoords);
	...
	public void method1897(int arg0, int arg1, ModelRendererGL arg2, int[][] arg3, int[][] arg4, int arg5, int arg6,
			int arg7) {
		...
		if (arg0 != 1 && arg0 != 2 && arg0 != 3 && arg0 != 5
				|| (i >= 0 && i_67_ + 128 >> 7 < arg3.length && i_68_ >= 0 && i_69_ + 128 >> 7 < arg3[0].length)) {
			if (arg0 == 4 || arg0 == 5) {
				if (arg4 == null || (i < 0 || i_67_ + 128 >> 7 >= arg4.length || i_68_ < 0
				...
				i_68_ >>= 7;
				i_69_ = i_69_ + 127 >> 7;
				if (arg3[i][i_68_] == arg6 && arg3[i_67_][i_68_] == arg6 && arg3[i][i_69_] == arg6
						&& arg3[i_67_][i_69_] == arg6)
					return;
			}
			if (arg0 == 1) {
				...
				for (int i_95_ = 0; i_95_ < realVertexCount; i_95_++) {
					...
					int i_103_ = ((arg4[i_100_][i_101_ + 1] * (128 - i_98_)
							+ arg4[i_100_ + 1][i_101_ + 1] * i_98_) >> 7);
				...
				for (int i_106_ = 0; i_106_ < realVertexCount; i_106_++) {
					...
					int i_114_ = ((arg3[i_111_][i_112_ + 1] * (128 - i_109_)
							+ arg3[i_111_ + 1][i_112_ + 1] * i_109_) >> 7);
	...
	public short addVertex(Model arg0, int triangleIdx, long arg2, int normalX, int normalY, int normalZ,
			int normalMagnitude, float textureU, float textureV) {
	...
	public ModelRendererGL method1903(boolean arg0, boolean arg1, boolean arg2, boolean arg3, boolean arg4,
			boolean arg5, boolean arg6, boolean arg7, boolean arg8, boolean arg9, boolean arg10) {
	...
	public static int getColourRGB(int colour1, short textureId, int NdotL, byte alpha) {
		...
		/*
		 * if (textureId != -1) { int i_127_ =
		 * Rasterizer.modelTextureSource.method14(textureId & 0xffff, 25); if (i_127_ !=
		 * 0) { int i_128_; if (NdotL < 0) i_128_ = 0; else if (NdotL > 127) i_128_ =
		 * 16777215; else i_128_ = 131586 * NdotL; if (i_127_ == 256) rgb = i_128_; else
		 * { int i_129_ = i_127_; int i_130_ = 256 - i_127_; rgb = ((((i_128_ &
		 * 0xff00ff) * i_129_ + (rgb & 0xff00ff) * i_130_) & ~0xff00ff) + ((i_128_ &
		 * 0xff00) * i_129_ + (rgb & 0xff00) * i_130_ & 0xff0000)) >> 8; } } int
		 * colourIntensity = 0;//Rasterizer.modelTextureSource.method9(textureId &
		 * 0xffff, -62); if (colourIntensity != 0) { colourIntensity += 256; int r =
		 * ((rgb & 0xff0000) >> 16) * colourIntensity; if (r > 65535) r = 65535; int g =
		 * ((rgb & 0xff00) >> 8) * colourIntensity; if (g > 65535) g = 65535; int b =
		 * (rgb & 0xff) * colourIntensity; if (b > 65535) b = 65535; rgb = (r << 8 &
		 * 0xff0000) + (g & 0xff00) + (b >> 8); } }
		 */
		return (rgb << 8) + (255 - (alpha & 0xff));
	}

	public void updateBuffers(boolean arg0, boolean usePositions, boolean useColours, boolean useNormals,
				...
				if (!Class7_Sub1.useLighting) {
					...
					for (int triangleId = 0; triangleId < triangleCount; triangleId++) {
						...
						if (normalMagA < 0)
							...
							if (normalMagA != 0)
								NdotLA = (intensity
										+ ((lightX * normalX[triA] + lightY * normalY[triA] + lightZ * normalZ[triA])
												/ (falloff * normalMagA)));
							else
								NdotLA = (intensity
										+ ((lightX * normalX[triA] + lightY * normalY[triA] + lightZ * normalZ[triA])
						...
						if (normalMagB < 0)
							...
							if (normalMagB != 0)
								NdotLB = (intensity
										+ ((lightX * normalX[triB] + lightY * normalY[triB] + lightZ * normalZ[triB])
												/ (falloff * normalMagB)));
							else
								NdotLB = (intensity
										+ ((lightX * normalX[triB] + lightY * normalY[triB] + lightZ * normalZ[triB])
						...
						if (normalMagC < 0)
							...
							if (normalMagC != 0)
								NdotLC = (intensity
										+ ((lightX * normalX[triC] + lightY * normalY[triC] + lightZ * normalZ[triC])
												/ (falloff * normalMagC)));
							else
								NdotLC = (intensity
										+ ((lightX * normalX[triC] + lightY * normalY[triC] + lightZ * normalZ[triC])
						...
						int i_167_ = getColourRGB(triangleColour[triangleId], triangleTexture[triangleId], NdotLA,
								triangleAlpha[triangleId]);
						int i_168_ = getColourRGB(triangleColour[triangleId], triangleTexture[triangleId], NdotLB,
								triangleAlpha[triangleId]);
						int i_169_ = getColourRGB(triangleColour[triangleId], triangleTexture[triangleId], NdotLC,
								triangleAlpha[triangleId]);
					...
					for (int i_170_ = 0; i_170_ < triangleCount; i_170_++) {
						int rgbColour = getColourRGB(triangleColour[i_170_], triangleTexture[i_170_], intensity,
								triangleAlpha[i_170_]);
	...
	public void replaceTexture(short textureId, short newTextureId) {
		...
		/*
		 * int i = 0; int i_181_ = 0; if (textureId != -1) { i =
		 * Rasterizer.modelTextureSource.method14(textureId & 0xffff, 82); i_181_ =
		 * Rasterizer.modelTextureSource.method9(textureId & 0xffff, -32); } int i_182_
		 * = 0; int i_183_ = 0; if (newTextureId != -1) { i_182_ =
		 * Rasterizer.modelTextureSource.method14(newTextureId & 0xffff, 70); i_183_ =
		 * Rasterizer.modelTextureSource.method9(newTextureId & 0xffff, -36); }
		 */
	...
	public void applyAnimationFrame(int arg1) {
		if (vertexSkin != null && arg1 != -1) {
			...
			for (int i = 0; i < animation.stepCount; i++) {
				...
				// applyVertex(0, 0, 0, 0);
				// applyVertex(modelTransform.opcodes[i_184_], animation.modifier1[i],
				// animation.modifier2[i], animation.modifier3[i]);
				// }
			}
			vertexPositions.upToDate = false;
			bounds.upToDate = false;
	...
	public void applyTransform(int arg1, boolean arg2) {
		if (vertexSkin != null && arg1 != -1) {
			...
			for (int i = 0; i < animation.stepCount; i++) {
				...
				// if (animation.aShortArray2338[i] != -1)
				// transformStep(0, (modelTransform.skinList[animation.aShortArray2338[i]]), 0,
				// 0, 0, arg2);
				transformStep(modelTransform.opcodes[i_188_], modelTransform.skinList[i_188_], animation.xOffset[i],
						animation.yOffset[i], animation.zOffset[i], arg2);
			}
			for (int i = 0; i < realVertexCount; i++) {
				vertexX[i] >>= 4;
				vertexY[i] >>= 4;
	...
	/*
	 * public void method1792(int arg0, int arg1, int arg2, int arg3, int arg4, int
	 * arg5, int arg6, int arg7, long arg8) { if (vertex_count != 0) { if
	 * (!bounds.upToDate) updateBounds(); int i = bounds.diagonal; int i_189_ =
	 * bounds.maxY; int i_190_ = bounds.minY; int i_191_ = arg7 * arg4 - arg5 * arg3
	 * >> 16; int i_192_ = arg6 * arg1 + i_191_ * arg2 >> 16; int i_193_ = i_192_ +
	 * (i * arg2 + i_190_ * arg1 >> 16); if (i_193_ > 50) { int i_194_ = i_192_ +
	 * (-i * arg2 + i_189_ * arg1 >> 16); if (i_194_ < 3584) { int i_195_ = arg7 *
	 * arg3 + arg5 * arg4 >> 16; int i_196_ = i_195_ + i << 9; if (i_196_ / i_193_ >
	 * StaticFields.negatedCenterX) { int i_197_ = i_195_ - i << 9; if (i_197_ /
	 * i_193_ < StaticFields.halfWidth) { int i_198_ = arg6 * arg2 - i_191_ * arg1
	 * >> 16; int i_199_ = (i_198_ + (i * arg1 + i_190_ * arg2 >> 16) << 9); if
	 * (i_199_ / i_193_ > StaticFields.negatedCenterY) { int i_200_ = (i_198_ + (-i
	 * * arg1 + i_189_ * arg2 >> 16) << 9); if (i_200_ / i_193_ <
	 * StaticFields.halfHeight) { int i_201_ = 0; int i_202_ = 0; if (arg0 != 0) {
	 * i_201_ = Rasterizer.SINE[arg0]; i_202_ = Rasterizer.COSINE[arg0]; }
	 * while_1226_: do { if (arg8 > 0L && Class90.aBoolean1417 && i_194_ > 0) { int
	 * i_203_; int i_204_; if (i_195_ > 0) { i_203_ = i_197_ / i_193_; i_204_ =
	 * i_196_ / i_194_; } else { i_203_ = i_197_ / i_194_; i_204_ = i_196_ / i_193_;
	 * } int i_205_; int i_206_; if (i_198_ > 0) { i_205_ = i_200_ / i_193_; i_206_
	 * = i_199_ / i_194_; } else { i_205_ = i_200_ / i_194_; i_206_ = i_199_ /
	 * i_193_; } if ((Class14_Sub2.anInt2726 >= i_203_) && (Class14_Sub2.anInt2726
	 * <= i_204_) && anInt2622 >= i_205_ && (anInt2622 <= i_206_)) { i_203_ =
	 * 999999; i_204_ = -999999; i_205_ = 999999; i_206_ = -999999; int i_207_ =
	 * bounds.maxX; int i_208_ = bounds.minX; int i_209_ = bounds.maxZ; int i_210_ =
	 * bounds.minZ; int[] is = {i_207_, i_208_, i_207_, i_208_, i_207_, i_208_,
	 * i_207_, i_208_}; int[] is_211_ = {i_209_, i_209_, i_210_, i_210_, i_209_,
	 * i_209_, i_210_, i_210_}; int[] is_212_ = {i_189_, i_189_, i_189_, i_189_,
	 * i_190_, i_190_, i_190_, i_190_}; for (int i_213_ = 0; i_213_ < 8; i_213_++) {
	 * int i_214_ = is[i_213_]; int i_215_ = is_212_[i_213_]; int i_216_ =
	 * is_211_[i_213_]; if (arg0 != 0) { int i_217_ = ((i_216_ * i_201_ + (i_214_ *
	 * i_202_)) >> 16); i_216_ = ((i_216_ * i_202_ - (i_214_ * i_201_)) >> 16);
	 * i_214_ = i_217_; } i_214_ += arg5; i_215_ += arg6; i_216_ += arg7; int i_218_
	 * = ((i_216_ * arg3 + i_214_ * arg4) >> 16); i_216_ = ((i_216_ * arg4 - i_214_
	 * * arg3) >> 16); i_214_ = i_218_; i_218_ = ((i_215_ * arg2 - i_216_ * arg1) >>
	 * 16); i_216_ = ((i_215_ * arg1 + i_216_ * arg2) >> 16); i_215_ = i_218_; if
	 * (i_216_ > 0) { int i_219_ = ((i_214_ << 9) / i_216_); int i_220_ = ((i_215_
	 * << 9) / i_216_); if (i_219_ < i_203_) i_203_ = i_219_; if (i_219_ > i_204_)
	 * i_204_ = i_219_; if (i_220_ < i_205_) i_205_ = i_220_; if (i_220_ > i_206_)
	 * i_206_ = i_220_; } } if ((Class14_Sub2.anInt2726 >= i_203_) &&
	 * (Class14_Sub2.anInt2726 <= i_204_) && (anInt2622 >= i_205_) && (anInt2622 <=
	 * i_206_)) { if (aBoolean3687)
	 * Class7_Sub3.aLongArray2685[Class14_Sub15.anInt2996++] = arg8; else { if
	 * (anIntArray5061.length < vertex_count) { anIntArray5061 = (new int
	 * [vertex_count]); anIntArray5057 = (new int [vertex_count]); } for (int i_221_
	 * = 0; (i_221_ < realVertexCount); i_221_++) { int i_222_ = (vertex_x[i_221_]);
	 * int i_223_ = (vertex_y[i_221_]); int i_224_ = (vertex_z[i_221_]); if (arg0 !=
	 * 0) { int i_225_ = (((i_224_ * i_201_) + (i_222_ * i_202_)) >> 16); i_224_ =
	 * (((i_224_ * i_202_) - (i_222_ * i_201_)) >> 16); i_222_ = i_225_; } i_222_ +=
	 * arg5; i_223_ += arg6; i_224_ += arg7; int i_226_ = (((i_224_ * arg3) +
	 * (i_222_ * arg4)) >> 16); i_224_ = (((i_224_ * arg4) - (i_222_ * arg3)) >>
	 * 16); i_222_ = i_226_; i_226_ = (((i_223_ * arg2) - (i_224_ * arg1)) >> 16);
	 * i_224_ = (((i_223_ * arg1) + (i_224_ * arg2)) >> 16); i_223_ = i_226_; if
	 * (i_224_ < 50) break while_1226_; int i_227_ = ((i_222_ << 9) / i_224_); int
	 * i_228_ = ((i_223_ << 9) / i_224_); int i_229_ = (vertexUsageCount[i_221_]);
	 * int i_230_ = (vertexUsageCount[(i_221_ + 1)]); for (int i_231_ = i_229_;
	 * (i_231_ < i_230_); i_231_++) { int i_232_ = ((vertexIndexes[i_231_]) - 1); if
	 * (i_232_ == -1) break; anIntArray5061[i_232_] = i_227_; anIntArray5057[i_232_]
	 * = i_228_; } } for (int i_233_ = 0; (i_233_ < triangle_count); i_233_++) {
	 * short i_234_ = (triangle_a[i_233_]); short i_235_ = (triangle_b[i_233_]);
	 * short i_236_ = (triangle_c[i_233_]); if (method1920((Class14_Sub2.anInt2726),
	 * (anInt2622), (anIntArray5057[i_234_]), (anIntArray5057[i_235_]),
	 * (anIntArray5057[i_236_]), (anIntArray5061[i_234_]), (anIntArray5061[i_235_]),
	 * (anIntArray5061[i_236_]))) {
	 * Class7_Sub3.aLongArray2685[Class14_Sub15.anInt2996++] = arg8; break; } } } }
	 * } } } while (false); GL gl = OpenGLManager.gl; GL11.glPushMatrix();
	 * GL11.glTranslatef((float) arg5, (float) arg6, (float) arg7);
	 * GL11.glRotatef((float) arg0 * 0.17578125F, 0.0F, 1.0F, 0.0F); render();
	 * GL11.glPopMatrix(); } } } } } } } }
	 */
						...
						if (i_271_ >= i_266_ && i_271_ <= i_267_) {
							...
							if (i_272_ != -1) {
								for (int i_276_ = 0; i_276_ < i; i_276_++) {
									if (i_270_ == is[i_276_] && i_271_ == is_247_[i_276_]
										...
										if (i_277_ != -1) {
											if (is_252_ == null) {
												...
												is_255_ = aNormals_5039.normalMagnitude = (cloneArray(8111,
														normalMagnitude));
											}
											if (is_256_ == null) {
	...
	public ModelRendererGL(Model model, int intensity, int falloff, boolean arg3) {
		...
		for (int i = 0; i < model.triangle_count; i++) {
			if ((model.triangleDrawType == null || (model.triangleDrawType[i] & 1) != 2)
					&& (model.triangleTexture == null || model.triangleTexture[i] == -1)) {
				is[triangleCount++] = i;
		...
		if (model.triangleDrawType != null && model.textureTriangleCount != 0) {
			...
			fs = new float[i_315_][];
			/*
			 * for (int i_331_ = 0; i_331_ < i_315_; i_331_++) { byte i_332_ =
			 * model.aByteArray3514[i_331_]; if (i_332_ > 0) { is_312_[i_331_] =
			 * (is_316_[i_331_] + is_317_[i_331_]) / 2; is_313_[i_331_] = (is_318_[i_331_] +
			 * is_319_[i_331_]) / 2; is_314_[i_331_] = (is_320_[i_331_] + is_321_[i_331_]) /
			 * 2; float f; float f_333_; float f_334_; if (i_332_ == 1) { int i_335_ =
			 * model.aShortArray3512[i_331_]; if (i_335_ == 0) { f = 1.0F; f_334_ = 1.0F; }
			 * else if (i_335_ > 0) { f = 1.0F; f_334_ = (float) i_335_ / 1024.0F; } else {
			 * f_334_ = 1.0F; f = (float) -i_335_ / 1024.0F; } f_333_ = 64.0F / (float)
			 * (model.aShortArray3522[i_331_] & 0xffff); } else if (i_332_ == 2) { f = 64.0F
			 * / (float) (model.aShortArray3512[i_331_] & 0xffff); f_333_ = 64.0F / (float)
			 * (model.aShortArray3522[i_331_] & 0xffff); f_334_ = 64.0F / (float)
			 * (model.aShortArray3527[i_331_] & 0xffff); } else { f = (float)
			 * model.aShortArray3512[i_331_] / 1024.0F; f_333_ = (float)
			 * model.aShortArray3522[i_331_] / 1024.0F; f_334_ = (float)
			 * model.aShortArray3527[i_331_] / 1024.0F; } fs[i_331_] =
			 * method1911(model.triPIndex[i_331_], model.triMIndex[i_331_],
			 * model.triNIndex[i_331_], model.aByteArray3516[i_331_] & 0xff, f, f_333_,
			 * f_334_); } }
			 */
		}
		for (int destTriangleIdx = 0; destTriangleIdx < triangleCount; destTriangleIdx++) {
			...
			if (sourceTexture != -1) {
				if (i_340_ == -1) {
					...
					if (i_350_ == 0) {
						 ...
						 * else { int i_382_ = model.triangle_a[sourceTriangleIndex]; int i_383_ =
						 * model.triangle_b[sourceTriangleIndex]; int i_384_ =
						 * model.triangle_c[sourceTriangleIndex]; int i_385_ = is_312_[i_340_]; int
						 * i_386_ = is_313_[i_340_]; int i_387_ = is_314_[i_340_]; float[] fs_388_ =
						 * fs[i_340_]; byte i_389_ = model.aByteArray3548[i_340_]; float f_390_ =
						 * (float) model.aByteArray3554[i_340_] / 256.0F; if (i_350_ == 1) { float
						 * f_391_ = ((float) (model.aShortArray3527[i_340_] & 0xffff) / 1024.0F);
						 * method1921(model.vertex_x[i_382_], model.vertex_y[i_382_],
						 * model.vertex_z[i_382_], i_385_, i_386_, i_387_, fs_388_, f_391_, i_389_,
						 * f_390_); tcAU = aFloat5064; tcAV = aFloat5060;
						 * method1921(model.vertex_x[i_383_], model.vertex_y[i_383_],
						 * model.vertex_z[i_383_], i_385_, i_386_, i_387_, fs_388_, f_391_, i_389_,
						 * f_390_); tcBU = aFloat5064; tcBV = aFloat5060;
						 * method1921(model.vertex_x[i_384_], model.vertex_y[i_384_],
						 * model.vertex_z[i_384_], i_385_, i_386_, i_387_, fs_388_, f_391_, i_389_,
						 * f_390_); tcCU = aFloat5064; tcCV = aFloat5060; float f_392_ = f_391_ / 2.0F;
						 * if ((i_389_ & 0x1) == 0) { if (tcBU - tcAU > f_392_) { tcBU -= f_391_; i_347_
						 * = 1; } else if (tcAU - tcBU > f_392_) { tcBU += f_391_; i_347_ = 2; } if
						 * (tcCU - tcAU > f_392_) { tcCU -= f_391_; i_348_ = 1; } else if (tcAU - tcCU >
						 * f_392_) { tcCU += f_391_; i_348_ = 2; } } else { if (tcBV - tcAV > f_392_) {
						 * tcBV -= f_391_; i_347_ = 1; } else if (tcAV - tcBV > f_392_) { tcBV +=
						 * f_391_; i_347_ = 2; } if (tcCV - tcAV > f_392_) { tcCV -= f_391_; i_348_ = 1;
						 * } else if (tcAV - tcCV > f_392_) { tcCV += f_391_; i_348_ = 2; } } } else if
						 * (i_350_ == 2) { float f_393_ = (float) model.aByteArray3518[i_340_] / 256.0F;
						 * float f_394_ = (float) model.aByteArray3529[i_340_] / 256.0F; int i_395_ =
						 * (model.vertex_x[i_383_] - model.vertex_x[i_382_]); int i_396_ =
						 * (model.vertex_y[i_383_] - model.vertex_y[i_382_]); int i_397_ =
						 * (model.vertex_z[i_383_] - model.vertex_z[i_382_]); int i_398_ =
						 * (model.vertex_x[i_384_] - model.vertex_x[i_382_]); int i_399_ =
						 * (model.vertex_y[i_384_] - model.vertex_y[i_382_]); int i_400_ =
						 * (model.vertex_z[i_384_] - model.vertex_z[i_382_]); int i_401_ = i_396_ *
						 * i_400_ - i_399_ * i_397_; int i_402_ = i_397_ * i_398_ - i_400_ * i_395_; int
						 * i_403_ = i_395_ * i_399_ - i_398_ * i_396_; float f_404_ = 64.0F / (float)
						 * (model.aShortArray3512[i_340_] & 0xffff); float f_405_ = 64.0F / (float)
						 * (model.aShortArray3522[i_340_] & 0xffff); float f_406_ = 64.0F / (float)
						 * (model.aShortArray3527[i_340_] & 0xffff); float f_407_ = (((float) i_401_ *
						 * fs_388_[0] + (float) i_402_ * fs_388_[1] + (float) i_403_ * fs_388_[2]) /
						 * f_404_); float f_408_ = (((float) i_401_ * fs_388_[3] + (float) i_402_ *
						 * fs_388_[4] + (float) i_403_ * fs_388_[5]) / f_405_); float f_409_ = (((float)
						 * i_401_ * fs_388_[6] + (float) i_402_ * fs_388_[7] + (float) i_403_ *
						 * fs_388_[8]) / f_406_); i_349_ = method1898(f_407_, f_408_, f_409_);
						 * method1888(model.vertex_x[i_382_], model.vertex_y[i_382_],
						 * model.vertex_z[i_382_], i_385_, i_386_, i_387_, i_349_, fs_388_, i_389_,
						 * f_390_, f_393_, f_394_); tcAU = aFloat5056; tcAV = aFloat5063;
						 * method1888(model.vertex_x[i_383_], model.vertex_y[i_383_],
						 * model.vertex_z[i_383_], i_385_, i_386_, i_387_, i_349_, fs_388_, i_389_,
						 * f_390_, f_393_, f_394_); tcBU = aFloat5056; tcBV = aFloat5063;
						 * method1888(model.vertex_x[i_384_], model.vertex_y[i_384_],
						 * model.vertex_z[i_384_], i_385_, i_386_, i_387_, i_349_, fs_388_, i_389_,
						 * f_390_, f_393_, f_394_); tcCU = aFloat5056; tcCV = aFloat5063; } else if
						 * (i_350_ == 3) { method1916(model.vertex_x[i_382_], model.vertex_y[i_382_],
						 * model.vertex_z[i_382_], i_385_, i_386_, i_387_, fs_388_, i_389_, f_390_);
						 * tcAU = aFloat5062; tcAV = aFloat5058; method1916(model.vertex_x[i_383_],
						 * model.vertex_y[i_383_], model.vertex_z[i_383_], i_385_, i_386_, i_387_,
						 * fs_388_, i_389_, f_390_); tcBU = aFloat5062; tcBV = aFloat5058;
						 * method1916(model.vertex_x[i_384_], model.vertex_y[i_384_],
						 * model.vertex_z[i_384_], i_385_, i_386_, i_387_, fs_388_, i_389_, f_390_);
						 * tcCU = aFloat5062; tcCV = aFloat5058; if ((i_389_ & 0x1) == 0) { if (tcBU -
						 * tcAU > 0.5F) { tcBU--; i_347_ = 1; } else if (tcAU - tcBU > 0.5F) { tcBU++;
						 * i_347_ = 2; } if (tcCU - tcAU > 0.5F) { tcCU--; i_348_ = 1; } else if (tcAU -
						 * tcCU > 0.5F) { tcCU++; i_348_ = 2; } } else { if (tcBV - tcAV > 0.5F) {
						 * tcBV--; i_347_ = 1; } else if (tcAV - tcBV > 0.5F) { tcBV++; i_347_ = 2; } if
						 * (tcCV - tcAV > 0.5F) { tcCV--; i_348_ = 1; } else if (tcAV - tcCV > 0.5F) {
						 * tcCV++; i_348_ = 2; } } } }
						 */
				}
			}
			...
			if (i_410_ == 0) {
				long arg2ofAV = ((long) (i_340_ << 2)
						+ (((long) (i_349_ << 24) + (long) (sourceColour << 8) + (long) sourceAlpha) << 32));
				int sourceTriangleA = model.triangle_a[sourceTriangleIndex];
				VertexNormal sourceNormalA = model.vertex_normals[sourceTriangleA];
				triangleA[destTriangleIdx] = addVertex(model, sourceTriangleA, arg2ofAV, sourceNormalA.x,
						sourceNormalA.y, sourceNormalA.z, sourceNormalA.magnitude, tcAU, tcAV);
				int sourceTriangleB = model.triangle_b[sourceTriangleIndex];
				VertexNormal sourceNormalB = model.vertex_normals[sourceTriangleB];
				triangleB[destTriangleIdx] = addVertex(model, sourceTriangleB, arg2ofAV + (long) i_347_,
						sourceNormalB.x, sourceNormalB.y, sourceNormalB.z, sourceNormalB.magnitude, tcBU, tcBV);
				int sourceTriangleC = model.triangle_c[sourceTriangleIndex];
				VertexNormal sourceNormalC = model.vertex_normals[sourceTriangleC];
				triangleC[destTriangleIdx] = addVertex(model, sourceTriangleC, arg2ofAV + (long) i_348_,
						sourceNormalC.x, sourceNormalC.y, sourceNormalC.z, sourceNormalC.magnitude, tcCU, tcCV);
			} else if (i_410_ == 1) {
				TriangleNormal triangleNormal = model.triangleNormals[sourceTriangleIndex];
				long l = ((long) ((i_340_ << 2) + (triangleNormal.x > 0 ? 1024 : 2048) + (triangleNormal.y + 256 << 12)
						+ (triangleNormal.z + 256 << 22))
						+ (((long) (i_349_ << 24) + (long) (sourceColour << 8) + (long) sourceAlpha) << 32));
				triangleA[destTriangleIdx] = addVertex(model, model.triangle_a[sourceTriangleIndex], l,
						triangleNormal.x, triangleNormal.y, triangleNormal.z, 0, tcAU, tcAV);
				triangleB[destTriangleIdx] = addVertex(model, model.triangle_b[sourceTriangleIndex], l + (long) i_347_,
						triangleNormal.x, triangleNormal.y, triangleNormal.z, 0, tcBU, tcBV);
				triangleC[destTriangleIdx] = addVertex(model, model.triangle_c[sourceTriangleIndex], l + (long) i_348_,
						triangleNormal.x, triangleNormal.y, triangleNormal.z, 0, tcCU, tcCV);
			}
			if (model.triangleTexture != null)
	...
	public static void method1916(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, float[] arg6, int arg7,
			float arg8) {
		arg0 -= arg3;
		arg1 -= arg4;
		arg2 -= arg5;
						...
						for (int i_453_ = 0; i_453_ < is.length; i_453_++) {
							...
							for (int i_457_ = i_455_; i_457_ < i_456_; i_457_++) {
								...
								if (vZOff != 0) {
									...
									normalY[i_458_] = (short) (((normalY[i_458_] * i_460_) - (normalX[i_458_] * i_459_)
											+ 32767) >> 16);
								...
								if (vXOff != 0) {
									...
									normalZ[i_458_] = (short) (((normalY[i_458_] * i_462_) + (normalZ[i_458_] * i_463_)
											+ 32767) >> 16);
								...
								if (vYOff != 0) {
									...
									normalZ[i_458_] = (short) (((normalZ[i_458_] * i_466_) - (normalX[i_458_] * i_465_)
											+ 32767) >> 16);
	...
	public static void method1921(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, float[] arg6, float arg7,
			int arg8, float arg9) {
		arg0 -= arg3;
		arg1 -= arg4;
		arg2 -= arg5;
