...
/**
 * Created by IntelliJ IDEA. User: Administrator Date: 7/31/11 Time: 10:21 PM To
...
public class AthmosphericEffects {
	...
	public static void setLightModel(int lightModelColour, float ambientModelModifier, float light1Modifier,
		...
		if (AthmosphericEffects.lightModelColour != lightModelColour
			...
			float[] lightModelAmbient = { ambientModelModifier * r, ambientModelModifier * g, ambientModelModifier * b,
					1.0F };
	...
	public static void setFogProperties(int fogColour, int fogDistanceModifier) {
		if (AthmosphericEffects.fogColour != fogColour
