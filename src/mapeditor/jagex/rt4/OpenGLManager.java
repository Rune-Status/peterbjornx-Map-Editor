...
/**
 * Created by IntelliJ IDEA. User: Peter Date: 6/20/11 Time: 12:09 AM Computer:
...
public class OpenGLManager {
	...
	public static boolean byte_order_bigendian = ByteOrder.nativeOrder() == ByteOrder.BIG_ENDIAN; // Set this to true
																									// for some exotic
																									// architectures
	public static boolean aBoolean2051 = has_vbo;
	public static boolean has_texture_3d = true;
