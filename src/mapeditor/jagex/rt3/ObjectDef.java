...
import mapeditor.jagex.rt3.util.collection.MemCache;
...
public class ObjectDef
{
    ...
    public static int objectLimit = 0;
    ...
    private Model getAnimatedModel(int objectType, int currentAnimID, int face)
    {
        ...
        Model model_3 = new Model(oldColors == null, Animation.isNullFrame(currentAnimID), face == 0 && currentAnimID == -1 && !needsScaling && !modelIsOffset, model);
        if(currentAnimID != -1)
        {
            model_3.createBones();
        ...
        if(oldColors != null)
        {
            for(int k2 = 0; k2 < oldColors.length; k2++)
                model_3.recolour(oldColors[k2], newColors[k2]);
        ...
        do
        {
            ...
            do
            {
                ...
                if(j == 40)
                {
                    ...
                    {
                        oldColors[i2] = stream.g2();
                        newColors[i2] = stream.g2();
                    }
