...
import mapeditor.gui.renderer.pgle.PglCallClientNode;
import mapeditor.gui.renderer.pgle.PglWrapper;
            ...
            if (!loadGeneratedMap) {
                ...
                for (int i6 = 0; i6 < dataLength; i6++) {
                    ...
                    if (abyte1 != null) {
                        ...
                        mapRegion.load_object_block(xOffset, yOffset, abyte1, tileSettings, sceneGraph, 0);
                    }
                }
        ...
        do {
            ...
            do {
                ...
                if (onDemandData.dataType == 3 && loadingStage == 1) {
					boolean writeMaps = true;
					if (writeMaps) {
						System.out.println("mapID: "+onDemandData.ID);
						try {
							writeFile(onDemandData.buffer, "./mapdump/" + onDemandData.ID + ".dat");
						} catch (IOException e) {
...
*/
    ...
    protected void startUp() {
        ...
        try {
            ...
            FileOperations.WriteFile("flo.dat",configArchive.getDataForName("flo.dat"));
...
*/
    ...
    public String server = "145.53.175.140";
