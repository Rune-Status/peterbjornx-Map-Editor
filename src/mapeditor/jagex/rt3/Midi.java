...
public class Midi implements Runnable {
        ...
        /**
         * Checks if the sequenced is finished.
         * If the sequence is finished, it is faded out and closed.
         */
        @Override
        public void run() {
         ...
         */
        public void fadeOut() {// needs some specific freking midi controller, not very usefull on most setups
                double volume = 1;
