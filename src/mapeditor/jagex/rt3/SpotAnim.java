...
public class SpotAnim {
    ...
    {//spotanim restored to 317
        mapeditor.jagex.rt3.Packet stream = new mapeditor.jagex.rt3.Packet(jagexArchive.getDataForName("spotanim.dat"));
    ...
    private void readValues(mapeditor.jagex.rt3.Packet stream)
    {
        do
        {
            ...
            if(opCode == 2)
            {
                ...
                if(mapeditor.jagex.rt3.Sequence.anims != null)
                    animationSequence = mapeditor.jagex.rt3.Sequence.anims[animationID];
            } else
            if(opCode == 4)
                resizeXY = stream.g2();
            else
