...
public class AnimationFrame {
	...
	public static void initialize(int i) {
		aAnimationArray635 = new mapeditor.jagex.rt3.AnimationFrame[i + 1];
	...
	public static void load(byte[] abyte0) {
		...
		for (int l1 = 0; l1 < k1; l1++) {
			int i2 = stream_1.g2();
			AnimationFrame animationFrame = aAnimationArray635[i2] = new AnimationFrame();
	...
	private static AnimationFrame[] aAnimationArray635;
